    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebApplication1.Models.Contexto>
    {
        ...
        protected override void Seed(WebApplication1.Models.Contexto context)
        {
            ...
            context.Estilos.AddOrUpdate(
                p => p.Nome,
                new Models.Estilos { Id = 1, Nome = "Tribal", Descricao = "Teste", Ativos = true },
                new Models.Estilos { Id = 2, Nome = "Tribal2", Descricao = "Teste", Ativos = true },
                new Models.Estilos { Id = 3, Nome = "Tribal3", Descricao = "Teste", Ativos = true },
                new Models.Estilos { Id = 4, Nome = "Tribal4", Descricao = "Teste", Ativos = true },
                new Models.Estilos { Id = 5, Nome = "Tribal5", Descricao = "Teste", Ativos = true },
                new Models.Estilos { Id = 6, Nome = "Tribal6", Descricao = "Teste", Ativos = true },
